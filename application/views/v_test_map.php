...
<div id="page-content-wrapper">
    ...
    <div class="col-lg-12 well">
		...
		<?php echo form_open('home/set_concact', 'class="form-horizontal"');?>
        <div class="row">
            <div class="col-xs-1">
            </div>
            <div class="col-xs-10">
                ...
                <div id="items_tel">
                    <div class="form-group row">
                        <p class="col-xs-5">
                            <input type="text" class="form-control"  placeholder="เบอร์โทร" name="tel[]" value="" >
                        </p>
                        <p class="col-xs-6">
...
$("#add_tel").click(function (e) {
            var max_num = 3;
            var html = '<div class="row form-group"><p class="col-xs-5"><input type="text" class="form-control"  placeholder="เบอร์โทร" name="input[]" value=""></p><p class="col-xs-2"><button type="button" class="btn btn-danger" id="delete_tel">ลบเบอร์</button></p></div>';
