...
<form action="<?php echo base_url('index.php/sell/guide')?>" method="post" enctype="multipart/form-data">
<div class="row">
	<div class="col-md-6">
		<div class="row">
		<div class="col-md-12">
				...
				<div class="form-group">
						...
						<div class="col-xs-6">
							<div class="input-group">
								<input type="number"  class="form-control" aria-describedby="basic-addon2" name="price" placeholder="ราคา เช่น 100" value="" min="0" required>
								<span class="input-group-addon">บาท</span>
							</div>
						</div>
						<div class="col-xs-1">
						...
						<div class="col-xs-5">
							<div class="input-group">
								<input type="text"  class="form-control"  name="unit" placeholder="กิโลกรรม หวี ถุง ฯลฯ" value="" required>
							</div>
						</div>
						</div>
				</div>
	...
	<div class="container-fluid">
		<button type="submit" class="btn btn-success btn-block" id="">แนะนำสินค้า</button>
	</div>
</div>
</form>
<script>
